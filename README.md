...
This [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,628 | 🐛 106 | 📅 2026-09-02 list helps software engineers **bootstrap billing & payments systems, and make sense of invoicing, pricing, accounting, marketplace, fraud and business intelligence**.
...
Billing is one of the transversal pillar of the ecosystem, where customers, products and business meets. The [other pillar being Identity and Access Management (IAM) 👤](https://github.com/kdeldycke/awesome-iam/) ⭐ 2,271 | 🐛 5 | 📅 2026-09-07.
...
* [Open guide to AWS](https://github.com/open-guides/og-aws#billing-and-cost-management) ⭐ 36,461 | 🐛 159 | 🌐 Shell | 📅 2024-08-16 - Links to the *Billing and Cost Management* section which details the broad characteristics of billing for a cloud provider.
...
* [Lago](https://github.com/getlago/lago) ⭐ 10,537 | 🐛 24 | 🌐 Go | 📅 2026-09-10 - 💸 Open-source metering & usage-based billing in Ruby. Lago SAS sells a hosted Cloud and Premium add-ons on top of the AGPL core.

* [CGRateS](https://github.com/cgrates/cgrates) ⭐ 515 | 🐛 69 | 🌐 Go | 📅 2026-09-12 - 🆓 An open-source, fast (50k+ CPS) and scalable (load-balancer + replication included) real-time billing for ISPs and Telecom Operators, written in Go. Vendor-neutral, support-only commercial model.
...
* [Lotus](https://github.com/uselotus/lotus) ⭐ 1,837 | 🐛 35 | 🌐 Python | 📅 2026-09-10 - 🆓 Open-source project to manage pricing & packaging infrastructure. Lotus Inc. only sells managed hosting on top of the MIT core.
...
* [Pimcore](https://github.com/pimcore/pimcore) ⭐ 3,847 | 🐛 376 | 🌐 PHP | 📅 2026-09-13 - 💸 An open-source UI and database to manage product metadata, written in PHP Symfony. Pimcore GmbH sells Enterprise Subscription, PaaS, and proprietary modules on top of the GPL/POCL core.
...
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,517 | 🐛 22 | 🌐 Go | 📅 2026-09-09 - 💸 Cloud cost estimates from Terraform code, surfaced as a breakdown in the terminal or as a diff in pull requests before resources are provisioned. Infracost Inc. sells a hosted dashboard (Infracost Cloud) on top of the Apache-2.0 CLI.
...
* [`sktime`](https://github.com/alan-turing-institute/sktime) ⭐ 10,007 | 🐛 2,468 | 🌐 Python | 📅 2026-09-13 - 🆓 Python library for time-series machine learning, governed by the Alan Turing Institute. See the [forecasting tutorial](https://github.com/alan-turing-institute/sktime/blob/master/examples/01_forecasting.ipynb) ⭐ 10,007 | 🐛 2,468 | 🌐 Python | 📅 2026-09-13 and the [differences between sktime and the Prophet project](https://news.ycombinator.com/item?id=24543861).

* [Darts](https://github.com/unit8co/darts) ⭐ 9,518 | 🐛 231 | 🌐 Python | 📅 2026-09-07 - 🆓 Python library for user-friendly forecasting and anomaly detection on time series, stewarded by Unit8 SA which only sells consulting around it (no paid library tier). Wraps a huge number of models, including [Prophet](https://facebook.github.io/prophet/). Great for experiments, but bear in mind that all the [models in Darts expects](https://news.ycombinator.com/item?id=37665435) that your data comes at a very regular interval, and make a lot of assumptions about their shape.
...
* [Papers we love: Auctions and Bidding](https://github.com/papers-we-love/papers-we-love/tree/master/economics#auctions-and-bidding) ⭐ 109,680 | 🐛 4 | 🌐 Shell | 📅 2026-08-31 - A collection of papers on bidding and auctions.
...
* [Frappe Books](https://github.com/frappe/books) ⭐ 4,951 | 🐛 141 | 🌐 TypeScript | 📅 2026-09-06 - 🆓 Free desktop book-keeping software for small-businesses and freelancers, with no paid edition.

* [Formance Ledger](https://github.com/formancehq/ledger) ⭐ 1,386 | 🐛 52 | 🌐 Go | 📅 2026-09-13 - 💸 MIT-licensed programmable double-entry ledger with the Numscript DSL, multi-currency, REST API, and Docker deployment usable standalone. Formance sells Enterprise add-ons (Wallets, Flows, Reconciliation, pre-built connectors, SSO, RBAC, audit logs) on top, but the core ledger is fully functional in OSS.
...
* [InvoicePlane](https://github.com/InvoicePlane/InvoicePlane) ⭐ 3,139 | 🐛 74 | 🌐 PHP | 📅 2026-09-11 - 🆓 A self-hosted open-source application for managing your invoices, clients and payments. Community project, no paid edition.

* [Invoice Builder](https://github.com/piratuks/invoice-builder) ⭐ 989 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-09 - 🆓 Offline-first desktop app to create, manage and export invoices and quotes to PDF, with all data kept in a local database you own.
...
* [Hyperswitch](https://github.com/juspay/hyperswitch) ⭐ 43,597 | 🐛 2,179 | 🌐 Rust | 📅 2026-09-13 - 💸 Open-source backend for payment processing. Juspay sells Hyperswitch Cloud and a self-host Enterprise edition; the OSS is functionally complete with 90+ connectors, vault, routing, 3DS, and fraud orchestration.

* [Polar](https://github.com/polarsource/polar) ⭐ 10,257 | 🐛 103 | 🌐 Python | 📅 2026-09-12 - 💸 Open-source monetization platform to sell SaaS and digital products. Polar Software Inc. runs the hosted polar.sh service as the merchant of record, handling billing, sales tax and VAT remittance for a cut of each transaction; the self-hostable OSS ships the full stack (checkout, subscriptions, usage metering, license keys) on top of your own Stripe account.
...
* [Awesome List of IAM: Fraud links](https://github.com/kdeldycke/awesome-iam#fraud) ⭐ 2,271 | 🐛 5 | 📅 2026-09-07 - Section dedicated to fraud management related to user accounts, from our sister repository.

<!--lint enable double-link-->

* [Awesome Fraud Detection Research Papers](https://github.com/benedekrozemberczki/awesome-fraud-detection-papers) ⭐ 1,832 | 🐛 2 | 🌐 Python | 📅 2026-01-05 - Papers sourced from several conferences on all sort of fraud: credit card, payment transactions, loans, customs inspections, money laundering networks, and more.
...
* [PyMC-Marketing](https://github.com/pymc-labs/pymc-marketing) ⭐ 1,259 | 🐛 447 | 🌐 Python | 📅 2026-09-13 - 🆓 A full-featured Python package to analyze your users based on their "alive" and "dead" states. Apache-2.0 library stewarded by PyMC Labs, which only sells consulting services around it (no paid library tier).
...
* [Apache Superset](https://github.com/apache/superset) ⭐ 74,744 | 🐛 607 | 🌐 Python | 📅 2026-09-13 - 🆓 Enterprise-ready business intelligence web application, governed by the Apache Software Foundation.
