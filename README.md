...
This [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,099 | 🐛 106 | 📅 2026-08-21 list helps software engineers **bootstrap billing & payments systems, and make sense of invoicing, pricing, accounting, marketplace, fraud and business intelligence**.
...
* [Lago](https://github.com/getlago/lago) ⭐ 10,379 | 🐛 25 | 🌐 Go | 📅 2026-08-21 - 💸 Open-source metering & usage-based billing in Ruby. Lago SAS sells a hosted Cloud and Premium add-ons on top of the AGPL core.
...
* [Pimcore](https://github.com/pimcore/pimcore) ⭐ 3,837 | 🐛 373 | 🌐 PHP | 📅 2026-08-23 - 💸 An open-source UI and database to manage product metadata, written in PHP Symfony. Pimcore GmbH sells Enterprise Subscription, PaaS, and proprietary modules on top of the GPL/POCL core.

## Calculator

Simulate a virtual invoice depending on the resource you plan to use.

* [Infracost](https://github.com/infracost/infracost) ⭐ 12,483 | 🐛 21 | 🌐 Go | 📅 2026-08-21 - 💸 Cloud cost estimates from Terraform code, surfaced as a breakdown in the terminal or as a diff in pull requests before resources are provisioned. Infracost Inc. sells a hosted dashboard (Infracost Cloud) on top of the Apache-2.0 CLI.
...
* [`sktime`](https://github.com/alan-turing-institute/sktime) ⭐ 9,959 | 🐛 2,386 | 🌐 Python | 📅 2026-08-23 - 🆓 Python library for time-series machine learning, governed by the Alan Turing Institute. See the [forecasting tutorial](https://github.com/alan-turing-institute/sktime/blob/master/examples/01_forecasting.ipynb) ⭐ 9,959 | 🐛 2,386 | 🌐 Python | 📅 2026-08-23 and the [differences between sktime and the Prophet project](https://news.ycombinator.com/item?id=24543861).

* [Darts](https://github.com/unit8co/darts) ⭐ 9,500 | 🐛 228 | 🌐 Python | 📅 2026-08-21 - 🆓 Python library for user-friendly forecasting and anomaly detection on time series, stewarded by Unit8 SA which only sells consulting around it (no paid library tier). Wraps a huge number of models, including [Prophet](https://facebook.github.io/prophet/). Great for experiments, but bear in mind that all the [models in Darts expects](https://news.ycombinator.com/item?id=37665435) that your data comes at a very regular interval, and make a lot of assumptions about their shape.
...
* [Papers we love: Auctions and Bidding](https://github.com/papers-we-love/papers-we-love/tree/master/economics#auctions-and-bidding) ⭐ 108,935 | 🐛 3 | 🌐 Shell | 📅 2026-07-01 - A collection of papers on bidding and auctions.
...
* [Frappe Books](https://github.com/frappe/books) ⭐ 4,894 | 🐛 224 | 🌐 TypeScript | 📅 2026-05-28 - 🆓 Free desktop book-keeping software for small-businesses and freelancers, with no paid edition.

* [Formance Ledger](https://github.com/formancehq/ledger) ⭐ 1,357 | 🐛 53 | 🌐 Go | 📅 2026-08-23 - 💸 MIT-licensed programmable double-entry ledger with the Numscript DSL, multi-currency, REST API, and Docker deployment usable standalone. Formance sells Enterprise add-ons (Wallets, Flows, Reconciliation, pre-built connectors, SSO, RBAC, audit logs) on top, but the core ledger is fully functional in OSS.
...
* [InvoicePlane](https://github.com/InvoicePlane/InvoicePlane) ⭐ 3,114 | 🐛 72 | 🌐 PHP | 📅 2026-08-23 - 🆓 A self-hosted open-source application for managing your invoices, clients and payments. Community project, no paid edition.
...
* [Factur-X](https://github.com/akretion/factur-x) ⭐ 302 | 🐛 10 | 🌐 XSLT | 📅 2026-08-18 - 🆓 Python library to support the e-invoicing standard for France and Germany.

* [GOBL](https://github.com/invopop/gobl) ⭐ 299 | 🐛 57 | 🌐 Go | 📅 2026-08-19 - 💸 JSON Schema, Open Source Go library, global tax database, with conversion tools, all in one. Invopop sells a managed e-invoicing SaaS implementation on top of the open spec.
...
* [Hyperswitch](https://github.com/juspay/hyperswitch) ⭐ 43,525 | 🐛 2,098 | 🌐 Rust | 📅 2026-08-22 - 💸 Open-source backend for payment processing. Juspay sells Hyperswitch Cloud and a self-host Enterprise edition; the OSS is functionally complete with 90+ connectors, vault, routing, 3DS, and fraud orchestration.
...
* [PyMC-Marketing](https://github.com/pymc-labs/pymc-marketing) ⭐ 1,240 | 🐛 431 | 🌐 Python | 📅 2026-08-23 - 🆓 A full-featured Python package to analyze your users based on their "alive" and "dead" states. Apache-2.0 library stewarded by PyMC Labs, which only sells consulting services around it (no paid library tier).
...
* [Apache Superset](https://github.com/apache/superset) ⭐ 74,418 | 🐛 625 | 🌐 Python | 📅 2026-08-22 - 🆓 Enterprise-ready business intelligence web application, governed by the Apache Software Foundation.

* [`redash`](https://github.com/getredash/redash) ⭐ 28,766 | 🐛 801 | 🌐 Python | 📅 2026-08-18 - 🆓 Connect and query your data sources, build dashboards to visualize data and share them with your company. Owned by Databricks but the hosted SaaS shut down in 2021, so the project is now community-maintained under the Databricks org with no paid Redash product.

* [Meltano](https://github.com/meltano/meltano) ⭐ 2,606 | 🐛 153 | 🌐 Python | 📅 2026-08-22 - 🆓 Open source convention-over-configuration product for the whole data lifecycle, all the way from loading data to analyzing it. Meltano only sells managed Cloud hosting and support SLA on top of the OSS core.
