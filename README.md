...
This [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,719 | 🐛 106 | 📅 2026-09-02 list helps software engineers **bootstrap billing & payments systems, and make sense of invoicing, pricing, accounting, marketplace, fraud and business intelligence**.
...
Billing is one of the transversal pillar of the ecosystem, where customers, products and business meets. The [other pillar being Identity and Access Management (IAM) 👤](https://github.com/kdeldycke/awesome-iam/) ⭐ 2,270 | 🐛 5 | 📅 2026-09-07.
...
* [Open guide to AWS](https://github.com/open-guides/og-aws#billing-and-cost-management) ⭐ 36,457 | 🐛 159 | 🌐 Shell | 📅 2024-08-16 - Links to the *Billing and Cost Management* section which details the broad characteristics of billing for a cloud provider.
...
* [Lago](https://github.com/getlago/lago) ⭐ 10,521 | 🐛 24 | 🌐 Go | 📅 2026-09-10 - 💸 Open-source metering & usage-based billing in Ruby. Lago SAS sells a hosted Cloud and Premium add-ons on top of the AGPL core.

* [CGRateS](https://github.com/cgrates/cgrates) ⭐ 514 | 🐛 71 | 🌐 Go | 📅 2026-09-07 - 🆓 An open-source, fast (50k+ CPS) and scalable (load-balancer + replication included) real-time billing for ISPs and Telecom Operators, written in Go. Vendor-neutral, support-only commercial model.
...
* [Lotus](https://github.com/uselotus/lotus) ⭐ 1,836 | 🐛 35 | 🌐 Python | 📅 2026-09-03 - 🆓 Open-source project to manage pricing & packaging infrastructure. Lotus Inc. only sells managed hosting on top of the MIT core.
...
* [Pimcore](https://github.com/pimcore/pimcore) ⭐ 3,845 | 🐛 372 | 🌐 PHP | 📅 2026-09-10 - 💸 An open-source UI and database to manage product metadata, written in PHP Symfony. Pimcore GmbH sells Enterprise Subscription, PaaS, and proprietary modules on top of the GPL/POCL core.
...
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,514 | 🐛 21 | 🌐 Go | 📅 2026-09-09 - 💸 Cloud cost estimates from Terraform code, surfaced as a breakdown in the terminal or as a diff in pull requests before resources are provisioned. Infracost Inc. sells a hosted dashboard (Infracost Cloud) on top of the Apache-2.0 CLI.
...
* [`sktime`](https://github.com/alan-turing-institute/sktime) ⭐ 10,000 | 🐛 2,453 | 🌐 Python | 📅 2026-09-10 - 🆓 Python library for time-series machine learning, governed by the Alan Turing Institute. See the [forecasting tutorial](https://github.com/alan-turing-institute/sktime/blob/master/examples/01_forecasting.ipynb) ⭐ 10,000 | 🐛 2,453 | 🌐 Python | 📅 2026-09-10 and the [differences between sktime and the Prophet project](https://news.ycombinator.com/item?id=24543861).

* [Darts](https://github.com/unit8co/darts) ⭐ 9,516 | 🐛 229 | 🌐 Python | 📅 2026-09-07 - 🆓 Python library for user-friendly forecasting and anomaly detection on time series, stewarded by Unit8 SA which only sells consulting around it (no paid library tier). Wraps a huge number of models, including [Prophet](https://facebook.github.io/prophet/). Great for experiments, but bear in mind that all the [models in Darts expects](https://news.ycombinator.com/item?id=37665435) that your data comes at a very regular interval, and make a lot of assumptions about their shape.

* [Komiser](https://github.com/mlabouardy/komiser) ⭐ 4,140 | 🐛 265 | 🌐 Go | 📅 2026-09-10 - 💸 Open-source tool to stay under budget by uncovering hidden costs, monitoring increases in spend, and making impactful changes based on custom recommendations. Tailwarden sells a hosted SaaS on top.
...
* [Papers we love: Auctions and Bidding](https://github.com/papers-we-love/papers-we-love/tree/master/economics#auctions-and-bidding) ⭐ 109,614 | 🐛 4 | 🌐 Shell | 📅 2026-08-31 - A collection of papers on bidding and auctions.
...
* [Frappe Books](https://github.com/frappe/books) ⭐ 4,945 | 🐛 141 | 🌐 TypeScript | 📅 2026-09-06 - 🆓 Free desktop book-keeping software for small-businesses and freelancers, with no paid edition.

* [Formance Ledger](https://github.com/formancehq/ledger) ⭐ 1,383 | 🐛 61 | 🌐 Go | 📅 2026-09-10 - 💸 MIT-licensed programmable double-entry ledger with the Numscript DSL, multi-currency, REST API, and Docker deployment usable standalone. Formance sells Enterprise add-ons (Wallets, Flows, Reconciliation, pre-built connectors, SSO, RBAC, audit logs) on top, but the core ledger is fully functional in OSS.
...
* [InvoicePlane](https://github.com/InvoicePlane/InvoicePlane) ⭐ 3,135 | 🐛 74 | 🌐 PHP | 📅 2026-09-09 - 🆓 A self-hosted open-source application for managing your invoices, clients and payments. Community project, no paid edition.

* [Invoice Builder](https://github.com/piratuks/invoice-builder) ⭐ 984 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-09 - 🆓 Offline-first desktop app to create, manage and export invoices and quotes to PDF, with all data kept in a local database you own.
...
* [GOBL](https://github.com/invopop/gobl) ⭐ 306 | 🐛 56 | 🌐 Go | 📅 2026-09-09 - 💸 JSON Schema, Open Source Go library, global tax database, with conversion tools, all in one. Invopop sells a managed e-invoicing SaaS implementation on top of the open spec.
...
* [Hyperswitch](https://github.com/juspay/hyperswitch) ⭐ 43,599 | 🐛 2,198 | 🌐 Rust | 📅 2026-09-10 - 💸 Open-source backend for payment processing. Juspay sells Hyperswitch Cloud and a self-host Enterprise edition; the OSS is functionally complete with 90+ connectors, vault, routing, 3DS, and fraud orchestration.

* [Polar](https://github.com/polarsource/polar) ⭐ 10,251 | 🐛 108 | 🌐 Python | 📅 2026-09-10 - 💸 Open-source monetization platform to sell SaaS and digital products. Polar Software Inc. runs the hosted polar.sh service as the merchant of record, handling billing, sales tax and VAT remittance for a cut of each transaction; the self-hostable OSS ships the full stack (checkout, subscriptions, usage metering, license keys) on top of your own Stripe account.

* [moov](https://github.com/moov-io) - 🆓 Suite of Apache-2.0 libraries for financial technology, including [`moov-io/ach`](https://github.com/moov-io/ach) ⭐ 563 | 🐛 17 | 🌐 Go | 📅 2026-09-09, [`iso8583`](https://github.com/moov-io/iso8583) ⭐ 532 | 🐛 22 | 🌐 Go | 📅 2026-09-09, and [`watchman`](https://github.com/moov-io/watchman) ⭐ 507 | 🐛 10 | 🌐 Go | 📅 2026-09-10. No paid product on top.
...
* [Awesome List of IAM: Fraud links](https://github.com/kdeldycke/awesome-iam#fraud) ⭐ 2,270 | 🐛 5 | 📅 2026-09-07 - Section dedicated to fraud management related to user accounts, from our sister repository.
...
* [PyMC-Marketing](https://github.com/pymc-labs/pymc-marketing) ⭐ 1,256 | 🐛 455 | 🌐 Python | 📅 2026-09-10 - 🆓 A full-featured Python package to analyze your users based on their "alive" and "dead" states. Apache-2.0 library stewarded by PyMC Labs, which only sells consulting services around it (no paid library tier).
...
* [Apache Superset](https://github.com/apache/superset) ⭐ 74,703 | 🐛 591 | 🌐 Python | 📅 2026-09-10 - 🆓 Enterprise-ready business intelligence web application, governed by the Apache Software Foundation.

* [`redash`](https://github.com/getredash/redash) ⭐ 28,786 | 🐛 803 | 🌐 Python | 📅 2026-09-03 - 🆓 Connect and query your data sources, build dashboards to visualize data and share them with your company. Owned by Databricks but the hosted SaaS shut down in 2021, so the project is now community-maintained under the Databricks org with no paid Redash product.

* [Meltano](https://github.com/meltano/meltano) ⭐ 2,622 | 🐛 145 | 🌐 Python | 📅 2026-09-09 - 🆓 Open source convention-over-configuration product for the whole data lifecycle, all the way from loading data to analyzing it. Meltano only sells managed Cloud hosting and support SLA on top of the OSS core.
